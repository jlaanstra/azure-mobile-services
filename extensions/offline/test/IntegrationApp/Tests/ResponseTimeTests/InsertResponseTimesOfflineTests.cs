...
{
    public class InsertResponseTimesOfflineTests : OfflineTestBase
    {
        ...
        [Tag("ResponseTime")]
        [AsyncTestMethod]
        public async Task Insert50ProductsOfflineTest()
        {
        ...
        [Tag("ResponseTime")]
        [AsyncTestMethod]
        public async Task Insert50ProductsOfflineTestOffline()
        {
            IMobileServiceTable<Product> table = this.OfflineClient.GetTable<Product>();
